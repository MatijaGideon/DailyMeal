...
public abstract class NetworkActivity extends LocationActivity implements NetworkReceiver.ConnectionListener {
    ...
    void showInfo(boolean isConnected) {
        if(isConnected)
            Snackbar.make(relativeLayout, R.string.connected_to_network,
