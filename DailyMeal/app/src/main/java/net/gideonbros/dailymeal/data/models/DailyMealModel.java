...
public class DailyMealModel extends RealmObject {
  @PrimaryKey int id;
  @NonNull String dailyMealName;
  @NonNull String dailyMealDescription;
  @NonNull String dailyMealImageUrl;
  @Nullable String dailyMealTopReview;
  @NonNull RestaurantModel restaurant;

  public DailyMealModel() {
  }

  public DailyMealModel(int id, @NonNull String dailyMealName, @NonNull String dailyMealDescription,
      @NonNull String dailyMealImageUrl, String dailyMealTopReview,
      @NonNull RestaurantModel restaurant) {
    this.id = id;
  ...
  @Nullable public String getDailyMealTopReview() {
    return dailyMealTopReview;
  }

  @NonNull public String getDailyMealName() {
    return dailyMealName;
  }

  @NonNull public String getDailyMealDescription() {
    return dailyMealDescription;
  }

  @NonNull public String getDailyMealImageUrl() {
